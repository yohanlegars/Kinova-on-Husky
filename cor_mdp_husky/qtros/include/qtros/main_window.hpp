...
#include "check_for_humans/camera_goal.h"
#include <string>
...
private:
	...
	QNode qnode;
        ...
        /**** publisher for state machine ****/
        
        ros::Publisher sm_monitor = n_.advertise<std_msgs::String>("sm_messages/stop_humans_check", 1000);
	    ros::Publisher sm_quit = n_.advertise<std_msgs::Empty>("/sm_messages/quit", 1000);
        ros::Publisher sm_connect  = n_.advertise<std_msgs::Empty>("/sm_messages", 1000);
        ...
        ros::ServiceClient get_point_of_interest_loc_client_;
        ros::ServiceClient ask_to_look_client_;
